...
```{r}
#Load CSV files of all UC crime statistics
...
Public_UC_Criminal_Offenses_Campus <- read.csv("Public_UC_Criminal_Offenses_Campus.csv")
...
Public_UC_Disciplinary_Actions_Campus <- read.csv("Public_UC_Disciplinary_Actions_Campus.csv")

Public_UC_Disciplinary_Actions_On_campus_Student_Housing_Facilities <- read.csv("Public_UC_Disciplinary_Actions_On_campus_Student_Housing_Facilities.csv")

Public_UC_VAWA_Offenses_Noncampus <- read.csv("Public_UC_VAWA_Offenses_Noncampus.csv")

Public_UC_VAWA_Offenses_Campus <- read.csv("Public_UC_VAWA_Offenses_Campus.csv")
