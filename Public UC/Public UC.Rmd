...
```{r}
head(Public_UC_VAWA_Offenses_On_campus)
```
...
sexual_crimes <- data.frame(year=Public_UC_VAWA_Offenses_On_campus$Survey.year, name=Public_UC_VAWA_Offenses_On_campus$Institution.name, size=Public_UC_VAWA_Offenses_On_campus$Institution.Size, total=Public_UC_VAWA_Offenses$domestic_violence+Public_UC_VAWA_Offenses$dating_violence+Public_UC_VAWA_Offenses$stalking+Public_UC_VAWA_Offenses$rape+Public_UC_VAWA_Offenses$fondling+Public_UC_VAWA_Offenses$statutory_rape)

head(Public_UC_VAWA_Offenses_Combined)
```
