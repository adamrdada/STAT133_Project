...
saveRDS(UC_criminal, "UC_criminal.Rds")
saveRDS(UC_arrests, "UC_arrests.Rds")
saveRDS(UC_disciplinary, "UC_disciplinary.Rds")
...
massPlot(NUC_arrests, Arrests, "Non-UC Arrests")
massPlot(NUC_arrests, ArrestsPerStudent, "Non-UC Arrests", TRUE)

massPlot(Berkeley_NUC_arrests, Arrests, "Berkeley vs. Non-UCs: Arrests")
massPlot(Berkeley_NUC_arrests, ArrestsPerStudent, "Berkeley vs. Non-UCs: Arrests", TRUE)

massPlot(Berkeley_summedNUC_arrests, Arrests, "Berkeley vs. Average Non-UC: Arrests")
massPlot(Berkeley_summedNUC_arrests, ArrestsPerStudent, "Berkeley vs. Average Non-UC: Arrests", TRUE)
...
massPlot(Berkeley_NUC_criminal, Crimes, "Berkeley vs. Non-UCs: Criminal Offenses")
massPlot(Berkeley_NUC_criminal, CrimesPerStudent, "Berkeley vs. Non-UCs: Criminal Offenses", TRUE)

massPlot(Berkeley_summedNUC_criminal, Crimes, "Berkeley vs. Average Non-UC: Criminal Offenses")
massPlot(Berkeley_summedNUC_criminal, CrimesPerStudent, "Berkeley vs. Average Non-UC: Criminal Offenses", TRUE)
...
massPlot(Berkeley_NUC_disciplinary, Arrests, "Berkeley vs. Non-UCs: Disciplinary Actions")
massPlot(Berkeley_NUC_disciplinary, ArrestsPerStudent, "Berkeley vs. Non-UCs: Disciplinary Actions", TRUE)

massPlot(Berkeley_summedNUC_disciplinary, Arrests, "Berkeley vs. Average Non-UC: Disciplinary Actions")
massPlot(Berkeley_summedNUC_disciplinary, ArrestsPerStudent, "Berkeley vs. Average Non-UC: Disciplinary Actions", TRUE)
```
...
massPlot(NorcalSocal_UC_criminal, Crimes, "Norcal vs. Socal UC Criminal Offenses")
massPlot(NorcalSocal_UC_criminal, CrimesPerStudent, "Norcal vs. Socal UC Criminal Offenses", TRUE)
```
```{r, warning=FALSE}
NorcalSocal_UC_arrests = socalNorcal(NorCal_UC_arrests, SoCal_UC_arrests, "Norcal", "Socal")

massPlot(NorcalSocal_UC_arrests, Arrests, "Norcal vs. Socal UC Arrests")
massPlot(NorcalSocal_UC_arrests, ArrestsPerStudent, "Norcal vs. Socal UC Arrests", TRUE)
...
massPlot(NorcalSocal_UC_disciplinary, Arrests, "Norcal vs. Socal UC Disciplinary Actions")
massPlot(NorcalSocal_UC_disciplinary, ArrestsPerStudent, "Norcal vs. Socal UC Disciplinary Actions", TRUE)
```
